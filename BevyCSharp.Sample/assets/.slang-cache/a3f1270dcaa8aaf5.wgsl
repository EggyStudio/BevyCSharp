...
{
    var _S12 : vec2<f32> = position_0.xy;
    var _S13 : vec3<i32> = vec3<i32>(vec2<i32>(_S12), i32(0));
    var _S14 : bcs_pass_Surface_0 = bcs_pass_surface_of_0((textureLoad((gbuffer_0), ((_S13)).xy, ((_S13)).z)));
    var _S15 : pixelOutput_0 = pixelOutput_0( vec4<f32>((textureSampleLevel((gathered_0), (picture_sampler_0), (_S12 / vec2<f32>(bcs_pass_picture_size_0())), (0.0f))).xyz * vec3<f32>(globalParams_0.strength_0) + _S14.base_color_0 * vec3<f32>((1.0f - _S14.metallic_0)) * vec3<f32>(0.0f), 0.0f) );
    return _S15;
}
