...
{
    var _S2 : pixelOutput_0 = pixelOutput_0( vec4<f32>((textureSampleLevel((gathered_0), (picture_sampler_0), (_S1.uv_0), (0.0f))).xyz * vec3<f32>(globalParams_0.scale_0), 1.0f) );
    return _S2;
}
