...
/// <param name="MemberName">Name of the member on the behaviour struct.</param>
/// <param name="Kind">How to reach it.</param>
internal sealed record ConditionInfo(string MemberName, ConditionKind Kind);

/// <summary>One stage-annotated method on a behaviour struct.</summary>
internal sealed record StageMethod
{
    ...
    /// (one invocation per entity carrying the behaviour).
    /// </summary>
...
internal sealed record BehaviorModel
{
    ...
    /// <summary>A globally unique, identifier-safe key for this behaviour.</summary>
