...
/// </summary>
/// <remarks>
/// These exist because the failure modes here are otherwise baffling. A behaviour struct that
...
internal static class BehaviorDiagnostics
{
    ...
    /// <summary>BCS002: no stage methods, so the behaviour does nothing.</summary>
    ...
    internal static readonly DiagnosticDescriptor UnknownCondition = new(
        ...
        messageFormat:
        "[RunIf(\"{0}\")] on '{1}' does not match any static bool member on the behaviour "
