...
/// <remarks>
/// <para>
/// For each behaviour the generator emits a runner class with one system method per stage, and
...
public sealed class BehaviorGenerator : IIncrementalGenerator
{
    ...
    private static ExtractResult? Extract(GeneratorAttributeSyntaxContext context, CancellationToken token)
    {
        ...
        // to be blittable. A behaviour with static methods alone is just a system holder.
    ...
    /// <summary>Resolves a <c>[RunIf]</c> attribute against the behaviour's own members.</summary>
