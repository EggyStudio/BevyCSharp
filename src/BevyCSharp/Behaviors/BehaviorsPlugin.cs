...
/// <summary>
/// Finds every generated behaviour registration in the loaded assemblies and runs it.
/// </summary>
/// <remarks>
/// <para>
...
{
    /// <summary>
    /// Directory watched for hot-reloadable behaviour scripts. Not yet implemented; leave
    /// <see langword="null"/> to use only compiled behaviours.
    /// </summary>
    public string? ScriptsDirectory { get; init; }

    /// <summary>Provenance tag applied to statically compiled behaviours.</summary>
    ...
    /// </summary>
    /// <remarks>
    /// On by default, because it is what makes a behaviour library that nothing has touched yet
    ...
    public void Build(App app)
    {
        ...
        if (ScriptsDirectory is not null)
        {
            Console.Error.WriteLine(
                ...
                + "compilation is not implemented yet; only compiled behaviours were registered.");
        }
    }
            ...
            foreach (var method in FindRegistrations(assembly))
            {
                ...
                catch (TargetInvocationException ex)
                {
                    throw new InvalidOperationException(
                        $"Behaviour registration '{method.DeclaringType?.Name}.{method.Name}' "
    ...
    /// <summary>
    /// True when <paramref name="method"/> is a generated behaviour registration.
    /// </summary>
    /// <remarks>
    ...
    /// exactly that - and it must not stop behaviour discovery for everything else.
    /// </remarks>
