...
/// <summary>
/// The body of a per-entity behaviour method.
/// </summary>
/// <typeparam name="T">The behaviour struct, which is also the component type.</typeparam>
...
/// <summary>
/// Drives per-entity behaviour methods over Bevy's storage.
/// </summary>
/// <remarks>
/// <para>
/// This is what the generated code calls. Keeping the iteration here rather than emitting it
/// per behaviour means the pointer arithmetic, the parallel partitioning and the filtering
...
public static class BehaviorRunners
{
    ...
    /// deliberately high: most behaviours run over tens or hundreds of entities, where a plain
    ...
    /// </summary>
    /// <typeparam name="T">The behaviour struct.</typeparam>
    /// <param name="world">The resource world.</param>
    /// <param name="body">The behaviour method to invoke per entity.</param>
