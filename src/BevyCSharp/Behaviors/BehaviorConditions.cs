...
public static class BehaviorConditions
{
    ...
    /// <summary>
    /// A keyboard toggle keyed by <typeparamref name="TTag"/>, usually the behaviour struct.
    /// </summary>
...
/// </summary>
/// <remarks>
/// This is what makes hot-reload swappable: a reloaded generation of behaviours registers under
