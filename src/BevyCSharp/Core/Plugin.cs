...
/// <summary>
/// The plugins every BevyCSharp app needs: engine resource wiring plus behaviour discovery.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Directory scanned for hot-reloadable behaviour scripts, or <see langword="null"/> to
    /// use only the behaviours compiled into loaded assemblies.
    /// </summary>
