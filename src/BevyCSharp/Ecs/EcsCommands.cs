...
/// invalidates every outstanding component reference - including the ones a behaviour is
...
/// </para>
/// <para>
/// This is also the only ECS surface that is safe to touch from a parallel behaviour method.
