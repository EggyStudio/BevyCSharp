//! Documents, stylesheets and widgets for Bevy.
//!
//! A copy of `bevy_extended_ui` that this project owns. See `NOTICE.md` beside this file for where
//! it came from, what was left out and why it was copied rather than depended on.
...
pub use bcs_ui_macros::BeuStore;
...
impl Default for ExtendedUiConfiguration {
    ...
    /// - `assets_path`: for preload images. Default `assets/bcs_ui/`
    ...
    fn default() -> Self {
        Self {
            ...
            assets_path: String::from("assets/bcs_ui/"),
